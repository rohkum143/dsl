...
def CheckOut() {
      try {
          ...
          // git 'https://github.com/shekharshamra/jenkin.git'
            checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/rohkum143/dsl.git']]]) 'https://github.com/shekharshamra/jenkin.git']]])
           }
