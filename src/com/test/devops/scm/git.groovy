...
def CheckOut(String GIT_URL) {
      try {
            ...
            checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'CleanBeforeCheckout'], [$class: 'RelativeTargetDirectory', relativeTargetDir: '/app/blue_ocean/jenkins/workspace/DSL-Test']], submoduleCfg: [], userRemoteConfigs: [[url: "${GIT_URL}"]]])
